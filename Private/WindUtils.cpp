...
{
    if (IsOnshore && DistanceToOcean < 100000.0f) // Onshore winds close to the ocean
    {
        Precipitation *= 1.0f + (0.2f * WindStrength); // Increase precipitation by wind strength
    ...
    {
        Precipitation *= 0.8f;                        // Decrease precipitation for offshore winds
